...
vent.on('paymentTypes:selected', showAllPaymentTypes);
vent.on('paymentType:selected', showFoodTrucksByPaymentType);
...
function showAllPaymentTypes() {
  jqxhr.done(function () {
    resultsView.showAllPaymentTypes();
  });
}

function showFoodTrucksByPaymentType(options) {
  jqxhr.done(function () {
    resultsView.showFoodTrucksByPaymentType(options.type);
  });
}
...
module.exports = {
  ...
  showAllPaymentTypes: showAllPaymentTypes,
  showFoodTrucksByPaymentType: showFoodTrucksByPaymentType,
};

},{"../collections/FoodTrucks":5,"../events/Vent":7,"../views/ResultsView":20}],7:[function(require,module,exports){
'use strict';
...
module.exports = Backbone.View.extend({
  ...
  initialize: function () {
    ...
    var navigationEvents = ['allTrucks', 'foodTypes', 'today', 'foodType', 'foodTruck', 'home', 'paymentTypes', 'paymentType'];
...
module.exports = Backbone.View.extend({
  events: {
    ...
    'click #paymentTypes': 'handlePaymentTypes',
  },
  ...
  handlePaymentTypes: function (ev) {
    ev.preventDefault();
    var path  = ev.currentTarget.href.replace(location.origin, '');
    vent.trigger('paymentTypes:selected', { path: path });
  }
});
...
},{"../events/Vent":7,"backbone":1}],19:[function(require,module,exports){
'use strict';
...
},{"./PaymentTypesItemView":18,"backbone":1}],20:[function(require,module,exports){
'use strict';
...
var FoodTruckView = require('./FoodTruckView');
var FoodTrucks = require('../collections/FoodTrucks');
var PaymentTypesView = require('./PaymentTypesView');
...
module.exports = Backbone.View.extend({
  ...
  showAllPaymentTypes: function () {
    ...
    this.listView = new PaymentTypesView({ collection: this.collection });
    this.$el.append(this.listView.render().el);
  },
  showFoodTrucksByPaymentType: function (type) {
    var filteredTrucks;
    ...
    if (type) {
      filteredTrucks = new FoodTrucks(this.collection.getTrucksByPaymentType(type));
      this.listView = new TrucksByTypeView({ collection: filteredTrucks, type: type });
      this.$el.append(this.listView.render().el);
    }
  }
...
},{"../collections/FoodTrucks":5,"./FoodTruckView":13,"./FoodTrucksView":14,"./FoodTypesView":16,"./PaymentTypesView":19,"./TodayView":21,"./TrucksByTypeView":22,"backbone":1}],21:[function(require,module,exports){
'use strict';
...
},{"./FoodTruckItemView":12,"backbone":1}],22:[function(require,module,exports){
'use strict';
