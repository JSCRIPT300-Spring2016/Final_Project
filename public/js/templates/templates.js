...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h2 class="listHeading">All Sartorial Types</h2>\r\n<ul class="foodTypesList"></ul>\r\n';

}
return __p
};

this["TFT"]["paymentTypeListItem"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a class="paymentTypeLink" href="/payment-types/' +
((__t = ( encodeURIComponent(type) )) == null ? '' : __t) +
'">' +
((__t = ( type )) == null ? '' : __t) +
'</a>\r\n';
...
this["TFT"]["paymentTypes"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h2 class="listHeading">All Payment Types</h2>\r\n<ul class="paymentTypesList"></ul>\r\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h2 class="listHeading">Sartorial trucks for ' +
((__t = ( type )) == null ? '' : __t) +
'</h2>\r\n<ul class="trucksList"></ul>\r\n';
...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h2 class="listHeading">Sartorial trucks available on ' +
((__t = ( today )) == null ? '' : __t) +
'</h2>\r\n<ul class="trucksList"></ul>\r\n';
