...
this["TFT"]["allProps"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<h2 class="listHeading">All Props</h2>\r\n<ul class="propsList"></ul>\r\n';
...
this["TFT"]["mdfPropListItem"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a class="foodTypeLink" href="/mdfProps/' +
((__t = ( encodeURIComponent(type) )) == null ? '' : __t) +
'">' +
((__t = ( type )) == null ? '' : __t) +
'</a>';
...
this["TFT"]["propListItem"] = function(obj) {
obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<a class="truckLink" href="/allProps/' +
((__t = ( name )) == null ? '' : __t) +
'">\r\n  <h2 class="detailHeading">' +
((__t = ( name )) == null ? '' : __t) +
'</h2>\r\n  <p class="foodType">' +
